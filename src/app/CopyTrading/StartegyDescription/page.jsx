            ...
            <div className="flex flex-col mt-16 max-md:mt-10 max-md:mr-1.5 max-md:max-w-full">
              <nav className="flex overflow-hidden flex-col pt-3 w-full bg-white rounded-lg shadow-sm max-md:max-w-full">
                <ul className="flex gap-3 items-center self-start pb-2 pl-6 text-xs leading-none text-neutral-500 max-md:pl-5 max-md:max-w-full">
                  <li className="self-stretch px-4 py-3 my-auto font-bold whitespace-nowrap text-neutral-800">
                    Positions
                  </li>
                  <li className="gap-2.5 self-stretch px-4 py-3 my-auto">
                    Position History
                  </li>
                  <li className="overflow-hidden gap-2.5 self-stretch px-4 py-3 my-auto whitespace-nowrap">
                    Copiers
                  </li>
                  <li className="overflow-hidden gap-2.5 self-stretch px-4 py-3 my-auto">
                    Mock Copiers
                  </li>
                </ul>
