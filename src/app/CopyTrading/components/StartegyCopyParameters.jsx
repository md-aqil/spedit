...
const TabItem = ({ icon, text }) => (
  ...
  const tabItems = [
    { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/b83a9e4cf7316342329cfdb588dbfda22a7e446a6751a6cc4179a566848c61f1?apiKey=b4d1b9e87b084579b1e2475047caf617&", text: "User Login" },
    { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/eef803a2cd17abf01f2bc1f8dc51e65a4a1ce4f7dc434125b4258e9f3c175ee5?apiKey=b4d1b9e87b084579b1e2475047caf617&", text: "Broker Connect" },
    { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/eef803a2cd17abf01f2bc1f8dc51e65a4a1ce4f7dc434125b4258e9f3c175ee5?apiKey=b4d1b9e87b084579b1e2475047caf617&", text: "Available Credits" }
  ];
        ...
        <div className="flex flex-wrap gap-3 items-center w-full text-sm font-semibold leading-none text-center max-md:max-w-full">
          <button
            className={`gap-2.5 self-stretch px-4 py-2 my-auto rounded ${
              isFixedRatio ? "bg-lime-500 bg-opacity-40 text-stone-950" : "text-stone-400"
            }`}
      ...
      <footer className="flex flex-col self-center mt-16 max-w-full text-sm w-[478px] max-md:mt-10">
        <div className="flex gap-2 justify-center items-center py-2 pr-2 w-full leading-none text-blue-500 max-md:max-w-full">
          ...
          <label htmlFor="agreement" className="flex items-center cursor-pointer">
            <span className={`w-6 h-6 border-2 rounded-sm mr-2 flex items-center justify-center ${isAgreed ? 'bg-black border-black' : 'border-gray-300'}`}>
              {isAgreed && (
            ...
            <span>
              ...
              <a href="#" className="text-blue-500">User service Agreement</a>
            </span>
          </label>
        </div>
        <div className="flex flex-col self-center mt-4 max-w-full font-bold leading-none text-center whitespace-nowrap rounded text-stone-950 w-[393px]">
          <button
            className={`gap-1 self-stretch px-7 py-5 rounded min-h-[50px] max-md:px-5 ${isAgreed && copyAmount && totalStopLoss ? 'bg-[#9BEC00] cursor-pointer' : 'bg-gray-300 cursor-not-allowed'}`}
...
<button   onClick={handleClosePopup} class="gap-1 self-stretch py-3.5 my-auto text-sm font-bold leading-none text-center rounded min-h-[42px] px-3.5 w-[87px] border border-solid border-neutral-500 text-stone-300">
Cancel
</button>
