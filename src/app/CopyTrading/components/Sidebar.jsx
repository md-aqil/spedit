...
function Sidebar() {
  return (
    <aside className="flex flex-col w-1/5 max-md:ml-0 max-md:w-full">
      <div className="flex flex-col items-center py-14 pr-9 mx-auto w-full bg-stone-950">
        <div className="flex gap-7 items-start text-xl font-bold leading-7 text-neutral-500">
        ...
        <nav className="flex gap-10 self-start mt-16 text-xl font-semibold text-white max-md:mt-10">
          <div className="flex shrink-0 my-auto w-1 h-10 bg-lime-500" />
        ...
        <div className="flex flex-col mt-20 max-w-full w-[233px] max-md:mt-10">
          ...
          <div className="flex flex-col mt-9 w-full text-xs text-neutral-500">
