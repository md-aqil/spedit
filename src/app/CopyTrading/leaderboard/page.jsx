          ...
          <nav className="flex flex-wrap gap-10 items-start px-0.5 w-full rounded-none max-w-[1120px] max-md:max-w-full">
            <div className="flex flex-col flex-1 mt-2 text-sm font-semibold text-center">
              <div className="flex gap-8 items-center">
                <span className="self-stretch my-auto text-stone-950 w-[75px]">Portfolios</span>
                <span className="self-stretch my-auto text-stone-400 w-[97px]">My Favorites</span>
              </div>
            ...
            <div className="flex flex-1 gap-6 items-start text-xs text-right text-stone-400">
              <form className="flex gap-1 justify-center items-center">
                <label htmlFor="searchInput" className="sr-only">Search traders or strategies</label>
                <input
                  type="search"
                  id="searchInput"
                ...
                <button type="submit" aria-label="Search">
                  <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/dc6607116dc7ad6bf48aeb42012737f62d0ecd9d87ddaa484b46d1c5d08c6760?apiKey=b4d1b9e87b084579b1e2475047caf617&" alt="" className="object-contain shrink-0 self-stretch my-auto w-6 aspect-square" />
                </button>
              </form>
              <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/ab4c0238bc26e17161b431e88dc8d5042544a7c477a432ac1c348087106c9bad?apiKey=b4d1b9e87b084579b1e2475047caf617&" alt="User profile" className="object-contain shrink-0 w-6 aspect-square" />
            </div>
          </nav>
