...
function LoginPage({ logoSrc, illustrationSrc }) {
        ...
        <section className="flex flex-col w-[46%] max-md:ml-0 max-md:w-full px-28">
          <div className="flex flex-col  mt-5">
            ...
            <div className="flex gap-5  w-full">
              <button className="flex gap-2 justify-center items-center px-4 py-4 rounded border border-neutral-800 text-sm font-bold w-full" aria-label="Log in with Google">
                <Image src={google} alt="Google Logo" width={14} height={14} className="w-3.5" />
                Log in with Google
              </button>
              <button className=" w-full flex gap-2 justify-center items-center px-4 py-4 rounded border border-neutral-800 text-sm font-bold" aria-label="Log in with Facebook">
  ...
  <span class="px-3 text-sm text-neutral-500">OR</span>
  <hr class="w-full border-t border-neutral-300" />
</div>
  ...
  <div className="flex items-center gap-2 px-5 py-2.5 mt-3 w-full text-black rounded-lg bg-stone-50">
    ...
    >
      <span className={`icon ${showPassword ? "icon-eye-slash" : "icon-eye"}`}></span>
    </button>
  </div>
</div>
              ...
              <div className="flex flex-col mt-9 text-stone-950">
                <div className="flex items-center text-xs">
                  <input
                    ...
                    className="w-5 h-5 bg-white rounded-sm border border-stone-950"
                  />
