...
function QuestCardSmall({
  ...
  return (
    <article className="flex flex-col max-w-[400px]  w-full">
      <div className="flex  gap-5 justify-between items-start pb-2 pl-5 mt-1.5 bg-white rounded-lg shadow-md border border-color-[#E9F0E1]">
        <div className="flex flex-col items-start my-auto">
          <div className="flex gap-1 justify-center items-center px-1 py-1 rounded-3xl bg-stone-300">
        ...
        <div className="flex z-10 flex-col self-end mt-0 whitespace-nowrap">
          ...
          <div className="flex relative flex-col px-6 pt-40 pb-2.5 mt-0 max-w-full text-xs font-extrabold leading-none text-lime-500 rounded aspect-[0.536] w-[103px]">
            <Image
