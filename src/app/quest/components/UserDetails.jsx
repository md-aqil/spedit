...
function UserDetails() {
  return (
    <div className="flex flex-col">
      <header className="flex flex-wrap gap-10 justify-between items-center px-9 py-4 w-full  bg-white bg-opacity-90 shadow-[0px_2px_4px_rgba(0,0,0,0.1)] max-md:px-5 max-md:max-w-full mb-5 rounded-lg" >
        <div className="flex gap-3 self-stretch my-auto min-h-[54px] min-w-[240px]">
          ...
          <div className="flex flex-col justify-between">
            <div className="flex flex-col max-w-full text-neutral-500">
              <div className="text-sm font-bold leading-none mb-3">Name</div>
              <div className="flex gap-1 items-center w-full text-xs leading-none">
                <div className="self-stretch my-auto">@Username</div>
                <div className="self-stretch my-auto font-semibold ml-3">Level 18</div>
              </div>
            </div>
        ...
        <nav className="flex gap-5  my-auto text-sm font-semibold leading-none text-center  text-neutral-800 ">
          {[
