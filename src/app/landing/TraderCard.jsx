...
import arrowUpIcon from "../../assets/Arrowup-bg.svg";
import JoinedUsers from "../../assets/JoinedUsers.png";
import ArrowDRed from "../../assets/Arrow-d-red.svg";
    ...
    <div className="flex overflow-hidden flex-col self-stretch my-auto min-w-[240px] w-[297px]">
      <div className="flex flex-col px-4 py-5 w-full bg-white rounded">
        <div className="flex gap-4 items-start whitespace-nowrap min-h-[42px]">
          <Image loading="lazy" alt={`${name}'s avatar`} className="object-contain shrink-0 w-10 rounded-full aspect-square" src={avatarSrc} />
        ...
        <div className="flex gap-10 justify-between items-center mt-5">
          <div className="flex flex-col self-stretch my-auto rounded-none w-[126px]">
            <div className="flex gap-2.5 justify-center items-center py-1 text-3xl font-semibold whitespace-nowrap rounded text-slate-900">
              <Image loading="lazy" src={arrowUpIcon} alt="" className="object-contain shrink-0 w-5 rounded-sm aspect-square" />
          ...
          <div className="flex flex-col self-stretch my-auto whitespace-nowrap rounded w-[39px] justify-center">
            <div className="self-stretch py-1.5 text-xl font-semibold bg-white rounded border text-center border-gray-300 border-solid text-slate-900">{riskLevel}</div>
        ...
        <div className="flex gap-3 items-start mt-12 w-full max-md:mt-10 justify-between">
          <div className="flex flex-col">
            <div className="flex gap-2 items-center text-sm whitespace-nowrap text-slate-500">
              <Image loading="lazy" alt="joined users" src={JoinedUsers} className="object-contain shrink-0 gap-0 self-stretch my-auto aspect-[2.71] w-[65px]" />
              <div className="flex-1 shrink self-stretch my-auto basis-0 text-ellipsis">{copiers} Copiers</div>
            </div>
            <div className="flex gap-2 self-start mt-3.5 text-base font-semibold leading-none text-slate-900">
              <Image loading="lazy" alt="Arrow Red" src={ArrowDRed} className="object-contain shrink-0 w-5 rounded-sm aspect-square" />
