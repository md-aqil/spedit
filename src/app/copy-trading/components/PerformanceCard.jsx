...
const PerformanceCard = ({
  ...
  roi,
  pnl,
  chartData = { labels: ['January', 'February', 'March', 'April', 'May'], values: [10, 20, 30, 40, 50] }, // Default to sample data if not provided
  pnlChartData = { labels: ['June', 'July', 'August', 'September', 'October'], values: [15, 25, 35, 45, 55] } // Example PnL data
}) => {
        ...
        <div className="flex flex-col w-full">
          <div className="flex flex-col justify-center self-center mt-6 w-full w-full">
            <div className="flex flex-wrap gap-10 justify-between items-center w-full">
              {[{
                label: "MDD", value: mdd, width: "50px"
              }, {
                label: "Win Rate", value: winRate, width: "82px"
              }, {
                label: "Profitable Positions", value: profitablePositions, width: "127px"
              }, {
                label: "Total Positions", value: totalPositions, width: "24"
            ...
            <div className="flex flex-wrap gap-10 justify-between items-center mt-8 w-full whitespace-nowrap max-md:max-w-full">
              {[{
                label: "ROI", value: roi, width: "79px"
              }, {
                label: "Pnl", value: pnl, width: "99px"
              }].map(({ label, value, width }) => (
