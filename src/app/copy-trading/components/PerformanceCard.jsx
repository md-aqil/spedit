      ...
      <div className="flex flex-col max-w-full w-[583px]">
        <div className="flex flex-wrap gap-10 justify-between items-start w-full text-black max-md:max-w-full">
          ...
          <div className="flex gap-2 items-center text-sm leading-none">
            ...
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/c296cf6667a009c8f981d82faa0357b67d9e274f3f2117b189e6612b611401df?apiKey=b4d1b9e87b084579b1e2475047caf617&"
              alt=""
              className="object-contain shrink-0 self-stretch my-auto w-3.5 rounded-none aspect-[0.93]"
            />
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-10 justify-between items-center mt-8 w-full whitespace-nowrap max-md:max-w-full">
            <div className="flex flex-col self-stretch my-auto w-[79px]">
              ...
              <div className="flex gap-2 items-center mt-2 text-xl font-bold leading-none text-stone-950">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/a44251c291de26e108239c7b5e48a9a7e2399179a33184c8b28142d583cb2158?apiKey=b4d1b9e87b084579b1e2475047caf617&"
                  alt=""
                  className="object-contain shrink-0 self-stretch my-auto w-3.5 aspect-[0.93] fill-lime-500"
                />
      ...
      <div className="flex gap-5 justify-between items-end mt-9 max-w-full text-sm leading-none text-center whitespace-nowrap w-[569px]">
        <div className="flex flex-col px-5 py-5 font-semibold rounded-lg border border-solid border-stone-300 min-h-[246px] min-w-[240px] w-[400px]">
          <div className="flex gap-3 items-center self-start">
            <span className="gap-2.5 self-stretch px-4 py-2 my-auto rounded bg-lime-500 bg-opacity-40 text-stone-950">
              ROI
            </span>
          ...
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/2da753f8a7a9e5532f91f59b2432fe28dcdefdc7afb720af9729244283c2c5e8?apiKey=b4d1b9e87b084579b1e2475047caf617&"
            alt="ROI and PnL chart"
            className="object-contain mt-2 max-w-full rounded-sm aspect-[2.08] w-[360px]"
          />
        </div>
