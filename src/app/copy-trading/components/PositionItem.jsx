...
function PositionItem({ name, amount, roi, unrealizedPnl, chart }) {
  ...
  const arrowIcon = isPositive
    ? "https://cdn.builder.io/api/v1/image/assets/TEMP/148f70afdcff2f4d3f6615c4e37f0853f485b1c5b3fd42710d8b5e893343f633?apiKey=b4d1b9e87b084579b1e2475047caf617&"
    : "https://cdn.builder.io/api/v1/image/assets/TEMP/94cb9af9c368b75a7b5b7872b078817ab2091802111973747a162f4d28b9377b?apiKey=b4d1b9e87b084579b1e2475047caf617&";
        ...
        <div className="flex flex-col whitespace-nowrap w-[66px]">
          ...
          >
            <img
              ...
              src={arrowIcon}
              alt=""
              className={`object-contain shrink-0 self-stretch my-auto w-3.5 aspect-square fill-${
                isPositive ? "lime" : "pink"
              }-500`}
            />
