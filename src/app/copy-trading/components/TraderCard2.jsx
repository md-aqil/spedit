...
const TraderCard = ({
  ...
  return (
    <div className="flex flex-col p-5 rounded-lg  bg-none w-[400px] trader-card2">
      <Link href="/copy-trading/leader-board" className="flex items-center gap-1 text-md font-semibold text-neutral-500 hover:text-neutral-700 transition-colors pb-4 back-link">
      ...
      <p className="flex-1 shrink gap-2 self-stretch mt-5 w-full text-sm leading-5 text-zinc-800">
        ...
        <span className="font-semibold leading-4 text-lime-500">
          <Link href="/copy-trading/strategy-description/readmore">Read more</Link>
        </span>
      </p>
