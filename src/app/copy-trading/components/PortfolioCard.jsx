...
const PortfolioCard = ({ name, rating, pnl, roi, aum, mdd, chartSrc, id }) => {
  return (
    <article id={id} className="flex flex-col grow shrink justify-center px-4 py-5 w-72 bg-white rounded-md shadow-sm min-h-[200px] min-w-[240px]">
      <div className="flex flex-col w-full">
        <header className="flex gap-10 justify-between items-center w-full whitespace-nowrap">
          <div className="flex gap-2.5 items-start self-stretch my-auto h-[43px]">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/270adb3606ee1d3784b0af464b59e50a13542e2044318273933d8f06e042dbf0?apiKey=b4d1b9e87b084579b1e2475047caf617&"
            ...
            <div className="flex flex-col py-1 w-[85px]">
              ...
              <div className="flex gap-1.5 items-center self-start mt-1.5 text-xs text-neutral-500">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/dc5ce9dc8e2d23be104e47c6bbc684a958e2fbf4aac48acce7ab0245196d26f8?apiKey=b4d1b9e87b084579b1e2475047caf617&"
                  alt="Rating stars"
          ...
          <div className="flex gap-4 items-center self-stretch my-auto text-sm font-bold text-center text-stone-950">
            ...
            <button className="gap-2 self-stretch p-3 my-auto bg-lime-500 rounded min-h-[38px] w-[76px]">
              <a href="/copy-trading/strategy-description/">Copy</a>
            </button>
          </div>
        </header>
            ...
            <div className="flex gap-5 items-center w-full">
              <div className="flex flex-col self-stretch my-auto w-28">
                ...
                <div className="flex gap-1.5 justify-center items-center py-1.5 mt-1 w-full text-xl font-bold whitespace-nowrap rounded text-stone-950">
                  <img
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/d491cef7465933f84a45e91e32148d243cc7b5e16a9866312b337704e274ad40?apiKey=b4d1b9e87b084579b1e2475047caf617&"
                    alt=""
