...
function StrategyList({
  ...
  return (
    <div className="relative">
        ...
        >
          <Image
            ...
            className={`transition-transform duration-200 ${
              favorites.includes(index) ? "scale-125" : ""
            }`}
          />
        </button>
      ...
      {(isPaused || isStopped) && (
        <div className="absolute top-4 right-4 text-black stop-label">
          {isPaused ? `Paused (${timestamp})` : `Stopped (${timestamp})`}
        </div>
      )}
