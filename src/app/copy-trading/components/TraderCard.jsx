...
const TraderCard = ({ copytraderData }) => {
  // Accepting an array with one trader object
        ...
        <div className="flex flex-wrap gap-5 items-start">
          ...
          >
            <div className="flex flex-col w-full">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Image
                      ...
                      width={24}
                      height={24}
                      className={`transition-transform duration-200 ${favorites.includes(trader.id) ? "scale-125" : ""}`}
                    />
                  </button>
              ...
              {cardsStatus[trader.id] && <div className="mt-4 text-xs text-gray-500">{cardsStatus[trader.id]}</div>}
            </div>
          </div>
        </div>
      </div>
