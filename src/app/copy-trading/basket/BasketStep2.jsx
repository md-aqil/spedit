...
function BasketStep2() {
  return (
    <main className="flex overflow-hidden flex-col px-5 py-6  bg-white rounded-xl">
   
      <section className=" px-4 py-12 w-full rounded-xl border border-solid bg-stone-50 border-stone-300 max-md:px-5 max-md:max-w-full">
          ...
          <div className="flex flex-col ml-5 w-[63%] max-md:ml-0 max-md:w-full">
            <div className="flex gap-2.5 items-start w-full leading-none max-md:mt-10 max-md:max-w-full">
              <input
                ...
                className="flex flex-col grow shrink-0 justify-center items-start border px-5 py-3 text-xs bg-white rounded-md basis-0 text-neutral-800 w-fit max-md:pr-5"
              />
