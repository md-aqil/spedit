...
const BasketStep5 = () => {
  return (
    <div className="flex overflow-hidden flex-col px-5  py-5 bg-white rounded-xl">
   

      <div className="flex overflow-hidden flex-col px-5 py-5  w-full rounded-xl border border-solid bg-stone-50 border-stone-300 max-md:px-5 max-md:mr-0.5 max-md:max-w-full">
                ...
                <div className="flex flex-col max-w-full w-[257px]">
                  ...
                  <div className="flex gap-3 items-center mt-3 w-full text-sm font-bold text-center">
                    <div className="flex gap-3 items-center self-stretch my-auto ">
                      <div className="gap-1 self-stretch px-7 py-3 my-auto bg-lime-500 rounded text-stone-950 whitespace-nowrap">
